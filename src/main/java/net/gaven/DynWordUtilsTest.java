...
//        String templatePaht = "E:\\Java4IDEA\\comm_test\\commutil\\src\\main\\resources\\wordtemplate\\审查报告模板1023体检表.docx";
        String templatePaht = "/usr/local/work/idea/poi-export-word/poi/src/main/java/net/wordtemplate/审查报告模板1023体检表.docx";
        // 输出位置
        String outPath = "/Users/ligang/Desktop";
        ...
        imgEntity.setUrl("/usr/local/work/idea/poi-export-word/poi/src/main/java/net/wordtemplate/1.jpg");
        ...
        imgEntity3.setUrl("/usr/local/work/idea/poi-export-word/poi/src/main/java/net/wordtemplate/image1.jpg");
        ...
        imgEntity1.setUrl("/usr/local/work/idea/poi-export-word/poi/src/main/java/net/wordtemplate/image1.jpg");
        ...
        imgEntity2.setUrl("/usr/local/work/idea/poi-export-word/poi/src/main/java/net/wordtemplate/image1.jpg");
    ...
    public void testImage() {
        ...
        Map<String, Object> paramMap = new HashMap<>(16);
        String templatePaht = "/usr/local/work/idea/poi-export-word/poi/src/main/java/net/wordtemplate/11.docx";
        String outPath = "/Users/ligang/Desktop/3.docx";
        ImageEntity imgEntity1 = new ImageEntity();
        imgEntity1.setHeight(500);
        imgEntity1.setWidth(400);
        imgEntity1.setUrl("/usr/local/work/idea/poi-export-word/poi/src/main/java/net/wordtemplate/image1.jpg");
